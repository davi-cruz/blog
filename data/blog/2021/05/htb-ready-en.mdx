...
As we can see in `nmap` output, a GitLab Server Community is running. Similar to <Link href="/blog/2021/04/htb-laboratory">Laboratory</Link>, proceeded with an account creation to have access to public repositories in this server that could help us proceed in this box.

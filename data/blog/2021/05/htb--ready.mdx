...
As we can see in `nmap` output, a GitLab Server Community is running. Similar to [Laboratory](/en-US/blog/2021/04/htb--laboratory), proceeded with an account creation to have access to public repositories in this server that could help us proceed in this box.

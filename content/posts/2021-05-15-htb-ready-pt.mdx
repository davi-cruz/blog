...
featuredImage: https://i.imgur.com/0eaJMfD.png
language: pt-BR
namespace: htb-ready
...
Conforme pode ser visto no resultado do `nmap` se trata de um serviço GitLab Community. Similar à máquina <Link to='/walkthrough/htb-ready'>**Laboratory**</Link>, segui com a criação de uma nova conta para verificar a versão do servidor e eventuais projetos públicos disponíveis.

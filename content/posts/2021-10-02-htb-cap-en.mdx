...
featuredImage:  https://i.imgur.com/JkBtXmO.png
language: en-US
namespace: htb-cap
tags:
- HackTheBox
...
This week's machine will be **Cap**, another easy-rated Linux box from [Hack The Box](https://www.hackthebox.eu/), created by [InfoSecJack](https://app.hackthebox.eu/users/52045). [more]

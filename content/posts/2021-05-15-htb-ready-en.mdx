...
As we can see in `nmap` output, a GitLab Server Community is running. Similar to <Link to="/en-US/walkthrough/htb-laboratory">**Laboratory**</Link>, proceeded with an account creation to have access to public repositories in this server that could help us proceed in this box.

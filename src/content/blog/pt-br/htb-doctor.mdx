---
title: 'Walkthrough: HTB Doctor'
description: Começando a postar sobre alguns write-ups de máquinas estilo CTF, a primeira
  a ser resolvida será Doctor, uma máquina Linux classificada como fácil do Hack The
  ...
pubDate: '2021-02-06'
tags:
- Walkthrough
...
<Alert kind="info" title="Info">
  Write-ups para máquinas do Hack The Box serão postados assim que as máquinas sejam aposentadas,
  então segue abaixo a primeira :smiley:!
</Alert>

![HTB Doctor](https://i.imgur.com/9JHTf6G.png)
...
![HTB Doctor - 80/TCP](https://i.imgur.com/1nI88F7.png)
...
![HTB Doctor - Secure Messaging](https://i.imgur.com/dFm4t4L.png)
...
![HTB Doctor - Secure Messaging - Creating User](https://i.imgur.com/TF2YP2x.png)
...
![HTB Doctor - Secure Messaging - Account creation](https://i.imgur.com/1HTEecu.png)
...
![HTB Doctor - Secure Messaging - New Post](https://i.imgur.com/MRYzW8b.png)
...
As coisas ficaram interessantes quando decidi acessar novamente o `/archive`, onde o conteúdo do título utilizado na mensagem criada foi exibido, o que levantou a possibilidade de obter um acesso inicial a partir da exploração via _Server-Side Template Injection (SSTI)_.
...
![HTB Doctor - Secure Messaging - SSTI test](https://i.imgur.com/ZNQ6zGx.png)
...
![HTB Doctor - SSTI output ](https://i.imgur.com/7rUfMmO.png)
...
![HTB Doctor - Exploit](https://i.imgur.com/j9kreyv.png)
...
![HTB Doctor - Splunkd](https://i.imgur.com/4225CjU.png)

![HTB Doctor - Services](https://i.imgur.com/JdygFIg.png)

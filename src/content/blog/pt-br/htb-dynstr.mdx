...
description: A máquina desta semana será Dynstr, outra máquina Linux classificada
  como mediana do Hack The Box, criada por jkr.
pubDate: '2021-10-16'
tags:
- HackTheBox
- HTB Medium
...
Embora seja um website que consiste apenas em um single page application, este site foi especialmente útil por conter informações muito interessantes na seção _Our Services_, que foram imprescindíveis durante a resolução desta máquina, além do domínio `dynadns.htb`, utilizado como endereço de e-mail no contato presente no rodapé:

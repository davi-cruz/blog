...
description: A máquina desta semana será Knife, outra máquina Linux classificada como
  fácil do Hack The Box, criada por MrKN16H.
pubDate: '2021-08-28'
tags:
- HackTheBox
- HTB Easy
...
A máquina desta semana será **Knife**, outra máquina Linux classificada como fácil do [Hack The Box](https://www.hackthebox.eu/), criada por [MrKN16H](https://app.hackthebox.eu/users/98767).
...
![HTB Knife - HTTP Service](https://i.imgur.com/oAbssxJ.png)
...
Como versões de desenvolvimento frequentemente contém vulnerabilidades, decidi buscar a respeito da mesma com `searchsploit` e encontrei uma vulnerabilidade de execução remota de código (RCE - _Remote Code Execution_) conforme listado abaixo:

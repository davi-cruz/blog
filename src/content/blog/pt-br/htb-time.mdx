---
title: 'Walkthrough: HTB Time'
description: A máquina desta semana será Time, outra máquina Linux classificada como
  mediana do Hack The Box, criada por egotisticalSW e felamos.
pubDate: '2021-04-03'
tags:
- HackTheBox
- Jackson
...
- HTB Medium
- Walkthrough
translationId: htb-time
draft: false
heroImage: https://i.imgur.com/jiSvU4u.png
---

Olá pessoal!

A máquina desta semana será **Time**, outra máquina Linux classificada como mediana do [Hack The Box](https://www.hackthebox.eu), criada por [egotisticalSW](https://app.hackthebox.eu/users/94858) e [felamos](https://app.hackthebox.eu/users/27390).
...
![HTB Time](https://i.imgur.com/mJmeefG.png)
...
![Online JSON Parser - Time](https://i.imgur.com/V6RbC9L.png)
...
![Online JSON Parser - Time - beautify](https://i.imgur.com/tpO2p3r.png)
...
![CVE Details](https://i.imgur.com/T2Kth6e.png)
...
![Listener and Webserver - Time](https://i.imgur.com/7o42urH.png)

![Online Json Parser - Sending the payload](https://i.imgur.com/Pv2Vbzy.png)

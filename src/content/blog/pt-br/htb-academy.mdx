---
title: 'Walkthrough: HTB Academy'
description: A máquina desta semana será Academy, outra máquina Linux classificada
  como fácil do Hack The Box, criada por egre55 e mrb3n.
pubDate: '2021-02-27'
tags:
- Walkthrough
- HackTheBox
...
![HTB Academy](https://i.imgur.com/aTyV5W3.png)
...
![HTB Academy - 80/TCP](https://i.imgur.com/j4KASf9.png)
...
![HTB Academy - Logged in](https://i.imgur.com/udKQN3c.png)
...
![HTB Academy - Admin Page](https://i.imgur.com/fCI3aBZ.png)
...
![HTB Academy - DevStaging](https://i.imgur.com/qzcJmuV.png)
...
O campo _data_ contém um valor em HEX do parametro utilizado nesta execução, que pode ser convertido para ASCII. Você pode utilizar qualquer conversor online mas também pode utilizar o `vim` para esta tarefa, conforme descrito abaixo:

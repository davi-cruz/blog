---
title: 'Walkthrough: HTB Ophiuchi'
description: A máquina desta semana será Ophiuchi, outra máquina Linux classificada
  como mediana do Hack The Box, criada por felamos.
pubDate: '2021-07-03'
tags:
- HackTheBox
- HTB Medium
- HTB Linux
- Walkthrough
translationId: htb-ophiuchi
draft: false
heroImage: https://i.imgur.com/r9JpwZX.png
---
...
![htb-ophiuchi](https://i.imgur.com/RgW95kn.png)
...
Ao buscar `define ophiuchi` no Google fui redirecionado para `define ophiucus`, que é uma constelação e seu nome em Português é _Serpentário_, o que faz algum sentido dado a imagem que temos um planeta e algumas estrelas, mas em breve veremos que não é apenas isso! \:smiley:
...
![Ophiuchi - Parse YAML](https://i.imgur.com/oDXT0S9.png)
...
![Ophiuchi - Tomcat Manager](https://i.imgur.com/x7m50Ah.png)

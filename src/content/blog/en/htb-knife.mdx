...
description: This week's machine will be Knife, another easy-rated Linux box from
  Hack The Box, created by MrKN16H.
pubDate: '2021-08-28'
tags:
- HackTheBox
- HTB Easy
...
This week's machine will be **Knife**, another easy-rated Linux box from [Hack The Box](https://www.hackthebox.eu/), created by [MrKN16H](https://app.hackthebox.eu/users/98767).

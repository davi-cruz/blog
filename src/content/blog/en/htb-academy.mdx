...
description: The box of this week will be Academy, another easy-rated Linux box from
  Hack the Box created by egre55 and mrb3n.
pubDate: '2021-02-27'
tags:
- Walkthrough
- HackTheBox
...
- Now pressing `i` we'll enter in _Insert Mode_ and paste the HEX content we want to convert, right after `00000000:`.

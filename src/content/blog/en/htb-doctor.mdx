...
description: Starting to post about some write-ups of CTF-like machines, the first
  one will be Doctor, an easy-rated Linux box from Hack The Box created by egotisticalSW.
pubDate: '2021-02-06'
tags:
- Walkthrough
- HackTheBox
...
<Alert kind="info" title="Info">
  Write-ups for Hack The Box will be posted as soon as machines get retired, so here's the first one
  :smiley:!
</Alert>

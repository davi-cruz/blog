...
A máquina desta semana será **Explore**, uma máquina Android classificada como fácil do [Hack The Box](https://www.hackthebox.eu/), criada por [bertolis](https://app.hackthebox.eu/users/27897).<!--more-->
